...
<?php 
    ...
    if(isset($_GET['id'])){
        ...
        $sql2 = "SELECT * FROM tbl_materials WHERE id=?";
...
$stmt = mysqli_prepare($conn, "UPDATE materials SET material_name=?, material_desc=?, material_price=?, material_qty=?, material_image=? WHERE id=?");

// bind the parameters to the statement
mysqli_stmt_bind_param($stmt, "ssdiss", $material_name, $material_desc, $material_price, $material_qty, $material_image, $id);
